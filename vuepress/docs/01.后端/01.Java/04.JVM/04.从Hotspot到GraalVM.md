...
对于JMX的支持，参考：[Build and Run Native Executables with Remote JMX](https://www.graalvm.org/latest/reference-manual/native-image/guides/build-and-run-native-executable-with-remote-jmx/)。

对于JFR的支持，参考：[Build and Run Native Executables with JFR](https://www.graalvm.org/latest/reference-manual/native-image/guides/build-and-run-native-executable-with-jfr/)。
