...
📚 **系列**：
- [基础篇](/pages/python-for-java-dev-base/) - Python基础语法、数据结构、面向对象
- [生态与质量管理](/pages/python-for-java-dev-package/) - Python生态、质量管理
...
# 手动控制事件循环（3.7之后不推荐，推荐使用asyncio.run）
...
- `asyncio.run()`：启动新的事件循环，运行协程并返回结果，通常用于程序入口和非async函数中
...
👈 **上一篇**：[Java开发者转战Python：基础篇](/pages/python-for-java-dev-base/) - Python基础语法、数据结构、面向对象编程

👉 **下一篇**：[Java开发者转战Python：生态与质量管理](/pages/python-for-java-dev-package/) - 探索Python生态系统和工程实践
