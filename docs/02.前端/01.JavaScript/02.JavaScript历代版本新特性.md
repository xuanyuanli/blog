---
title: JavaScript历代版本新特性
date: 2025-02-06 21:20:00
...
JavaScript 由 TC39（ECMA International 的第39号技术委员会）管理，通过社区驱动的方式制定标准，采用`提案驱动的发布模型（Proposal-Based Release Model）`。
